...
import '@/utils/leaflet-measure-path/leaflet-measure-path.js'
import '@/utils/leaflet-measure-path/leaflet-measure-path.css'

var deleteIcon = L.icon({
  iconUrl: require('../assets/images/tool/shanchu.png'),
  iconSize: [16, 16],
  iconAnchor: [10, 20]
})
// 测量距离
